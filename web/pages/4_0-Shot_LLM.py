...
st.write('However, 0-shot learning nevertheless is more efficient than few-shot learning given that the prompt comprises fewer tokens (i.e. is shorter and faster to process), while simultaneously consuming fewer resources.')