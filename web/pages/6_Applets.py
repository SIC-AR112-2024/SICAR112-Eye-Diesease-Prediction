...
def load_model3(MODEL_PATH):
    ...
    # Define the model with a specific number of classes

    e_model_1 = ReSNeT18(num_classes=4)
    e_model_2 = ReSNeT34(num_classes=4)
    ...
    e_model_3 = custom_resnet18(num_classes=4)
    ...
    class_weights_model3 = [0.8744075829,	0.86492891,	0.691943128,	0.7772511848]


    # Instantiate the ensemble model with class-specific weights
    ensemble_model = EnsembleModel(
        [e_model_1, e_model_2, e_model_3],
        class_weights=[class_weights_model1, class_weights_model2, class_weights_model3]
    )
    ensemble_model.load_state_dict(torch.load(MODEL_PATH, map_location='cpu'))
