...
st.markdown(f"[GoogLeNet and Pretrained ResNets]({colab_url1})")
st.markdown(f"[Ensemble Model]({colab_url2})")
st.markdown(f"[0 Shot OpenAI]({colab_url5})")
st.markdown(f"[0 Shot Gemini and Few Shot OpenAI]({colab_url3})")
