...
st.write("From our research, we have found out that the models used for scientific research range from 86 - 99% accuracy. The accuracies of the models that we utilised for our diagnosis applet all range from 89 - 91%, which would place our model on the lower side of this range. This is a considerable achievement, considering the limitations of our Graphic Processing Unit (GPU) resources that we faced. We also found out that models that practice 4-class classification had higher accuracies as compared to those that analyse more classes of eye diseases like 6-class classification. Given that our model practices 4-class classification with only 4 label classes, our model does underperform current research. We believe that computational resources may be key in this case, as scientific researchers usually have access to more computationally powerful GPUs like the A100 GPU with 80 GigaBytes (GB) of Random Assorted Memory (RAM), while we are only able to access the powerful but still computationally limited L4 GPU with a RAM of 22.5 GB.")

st.subheader("References to Research")
st.markdown("[1. Review of Machine Learning Applications Using Retinal Fundus Images](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8774893/)")
st.markdown("[2. Development of a Fundus Image-Based Deep Learning Diagnostic Tool for Various Retinal Diseases](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8142986/)")
st.markdown("[3. Deep Learning Fundus Image Analysis for Diabetic Retinopathy and Macular Edema Grading](https://www.nature.com/articles/s41598-019-47181-w)")
st.markdown("[4. Artificial Intelligence for Screening of Multiple Retinal and Optic Nerve Diseases](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC9066285/)")